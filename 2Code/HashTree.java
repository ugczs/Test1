...
/**
 * Hash Tree Klasse
 * berechnet einen Hash Tree
 * @author Yuguan Zhao
 */
public class HashTree {
	/*Wurzelknoten von Hash Tree*/
	private Node root;
	/*Datenblocke*/
    private List<String> itemList;
    /*Blaetter von Hash Tree*/
    private List<Node> nodeList;
    /*Liste mit Commitment-Komponenten*/
	...
	/**
     * Diese Methode berehnet den neuen Elternknotenwert nur,
     * wenn seine Kinder keine Kinderknoten mehr haben
     */
	...
	/**
     * Diese Methode berehnet den neuen Wurzelwert mit den
     * neulich hinzugefügten Knoten
     */
