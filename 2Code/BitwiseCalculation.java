/**
 * Diese Klasse berechnet bitweise Ergebnisse mit Eingaben von 0 oder 1
 * @author Yuguan Zhao
 */
public class BitwiseCalculation {
	/**
	 * Matrix-Addition
	 * @param a das erste Bit
	 * @param b das zweite Bit
	 * @return Ergebnis
	 */
    ...
    /**
   	 ...
   	 * @return Ergebnis
   	 */
       public int[][] subtractVektor(int[][] a, int[][] b) {
       	int row = a.length;
       	int col = a[0].length;
       	int[][] c = new int[row][col];
       	if(b.length != row || b[0].length != col) {
